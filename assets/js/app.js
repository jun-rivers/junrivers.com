$(document).ready(function() {
  ...
  if (lang) {
    ...
    // LANGUAGE DETECTION FOR IE/SAFARI/CHROME/FF
  ...
  function setLanguage(lang) {
    ...
    $('.text.'+lang).addClass('active');

    $('aside span.active').removeClass('active');
    $('aside span.'+lang).addClass('active');
  ...
  // LAUNCH ARTIST STATEMENT
  $('.a-s').on('click', function(event) {
    $('body').addClass('show-artist-statement');
    return false;
  });
  ...
  $('.btn-back').on('click', function() {
    $('body').removeClass('show-artist-statement');
  });
